...
1. **Issue 작성 가이드**: GitHub Issue 템플릿 종류와 선택 기준
1. **Pull Request 제출 절차**: 브랜치 전략, PR 템플릿, 리뷰 프로세스
...
1. **작성 팁**: 좋은 Issue를 작성하기 위한 간단한 안내 사항 (구체적 재현 단계, 환경 정보 포함 등)
...
1. **PR 작성**: PR 템플릿 활용법 및 필수 입력 항목 안내
1. **리뷰 프로세스**: PR 제출 후 리뷰 및 머지 절차
